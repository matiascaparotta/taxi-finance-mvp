...
conductor de `Lic1315`, con vehículo propio y combustible por
...
Después se corrigió su clasificación laboral: Alberto es asalariado y no
propietario. Su navegación queda reducida a jornada, mensual e historial; el
resumen mensual se personaliza con información exclusivamente propia y omite
por completo Equipo, Mis conductores y las reglas económicas de Lic249.
